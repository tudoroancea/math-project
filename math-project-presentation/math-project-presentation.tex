...
\begin{frame}
    ...
    % Final state:  [  2.14008167   1.09043004 114.19183962 112.90690575]
    % Final control:  [   14.19009197 -1114.01512478]
    % total_cost = 1424.3123462215194, iterations = 75, constraints_violated = True

    % MPC : 
    % ==========================
    % Converged at iteration 73
    % Final state:  [  2.14007811   1.09043741 114.19184186 112.90689261]
    % Final control:  [   14.19009186 -1114.02693947]
    % total_cost = 1412.6535688220122, iterations = 74, constraints_violated = False
