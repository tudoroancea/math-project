...
\begin{lemma}
	\label{thm:RRLB-quadratic-bound}
...
\begin{lemma}
	...
	Consider the problem \ref{eq:RRLB-NMPC} and re-write it in a simpler way as 
...
\begin{proof}~
	...
	Now using the optimal sequence of states and controls of the problem \ref{eq:RRLB-NMPC} starting at $x$, we can construct new feasible sequences for the problem starting at $\tilde{x}_1(x)$ as 
